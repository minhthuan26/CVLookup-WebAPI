...
namespace CVLookup_WebAPI.Controllers
{
	...
	public class AuthController : ControllerBase
	{
		...
		public async Task<IActionResult> RestoreRefreshToken([FromQuery] string userId, [FromQuery] string connectionId)
		{
			await _authService.RestoreRefreshToken(userId, connectionId);
			return Ok();
		}
	}
}
